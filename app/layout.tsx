...
const siteDescription =
  "株式会社キャリア・リードは、特定技能外国人の採用から在留資格の申請、入社後の定着支援までワンストップで伴走する登録支援機関です。25年の人材紹介ノウハウを活かし、介護・自動車運送・工業製品製造・飲食料品製造・建設の各分野で、意欲ある海外人材をご紹介。人手不足の現場に確かな一手を提供します。";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "特定技能外国人の採用から在留資格申請、入社後の定着支援までワンストップで伴走。登録支援機関として、人手不足の現場に意欲ある海外人材をご紹介します。",
    url: siteUrl,
    locale: "ja_JP",
    type: "website",
  },
